		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'Cargo' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'Cargo' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'Cargo' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'Cargo' ),
						'full'    => esc_html__( 'Full text', 'Cargo' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new Twenty_Twenty_One_Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'Cargo' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
