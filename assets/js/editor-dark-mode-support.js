/* global CargoIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'Cargo-supports-dark-theme' ) ) {
	CargoDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function CargoDarkModeEditorInit( attempt ) {
	...
	if ( CargoIsDarkMode() ) {
		if ( null === container ) {
			...
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						CargoDarkModeEditorInit( attempt + 1 );
					},
